...
Mapbox for WP Advanced diplays rich and beautiful Mapbox maps in your WordPress websites with a lot of powerful features but no coding!
...
1. Upload `mapboxforwpadv.php` to the `/wp-content/plugins/` directory
